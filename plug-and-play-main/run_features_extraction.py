...
def main(config_experiment_name, config_init_img, image_name):
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="configs/pnp/feature-extraction.yaml",
    ...
    exp_config.config.init_img = config_init_img
    exp_config.config.experiment_name = config_experiment_name
