...
from diffusers_old.configuration_utils import ConfigMixin, register_to_config
from diffusers_old.modeling_utils import ModelMixin
from diffusers_old.utils import BaseOutput, logging
from diffusers_old.models.embeddings import TimestepEmbedding, Timesteps
...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin, PeftAdapterMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs):
        ...
        __version__ = diffusers_old.__version__
        from diffusers_old.utils import (
            CONFIG_NAME,
            DIFFUSERS_CACHE,
        ...
        from diffusers_old.modeling_utils import load_state_dict
