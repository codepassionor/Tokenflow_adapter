...
class Vid2VidZeroPipeline(StableDiffusionPipeline):
    r"""
    ...
    def __init__(
        ...
        lora_inuse: bool = True,
        withlora: bool = False
    ):
        super().__init__(vae=vae, text_encoder=text_encoder, tokenizer=tokenizer, unet=unet, scheduler=scheduler, safety_checker= safety_checker, feature_extractor=feature_extractor)
        self.lora_inuse = lora_inuse
        self.withlora = withlora
