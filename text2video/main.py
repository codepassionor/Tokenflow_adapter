...
if __name__ == "__main__":
    ...
    CLIP_score_lora = []
    IPIPS_score_lora = []
    model_name = "/root/autodl-tmp/cache_huggingface/huggingface/hub/models--runwayml--stable-diffusion-v1-5/"
    ...
    for i in range(20):
        ...
        with open(f'/root/autodl-tmp/research/Tokenflow_adapter/TokenFlow/data/test_{i}.json') as f:
