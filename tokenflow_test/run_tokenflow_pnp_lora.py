...
class TokenFlow(nn.Module):
    def __init__(self, config):
        ...
        if sd_version == '2.1':
            ...
            model_key = "/root/autodl-tmp/cache_huggingface/huggingface/hub/models--runwayml--stable-diffusion-v1-5/"
        ...
        pipe.load_lora_weights("/root/autodl-fs/rank4_0.001/checkpoint-100000/pytorch_lora_weights.safetensors")
