...
import diffusers_old
import transformers
from accelerate import Accelerator
from accelerate.logging import get_logger
from accelerate.utils import set_seed
from diffusers_old import AutoencoderKL, DDPMScheduler, DDIMScheduler
from diffusers_old.optimization import get_scheduler
from diffusers_old.utils import check_min_version
from diffusers_old.utils.import_utils import is_xformers_available
...
def main(
    ...
    output_dir = f'{lora_begin}/' + output_dir + "/lora"
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    if accelerator.is_local_main_process:
        ...
        diffusers_old.utils.logging.set_verbosity_info()
    else:
        transformers.utils.logging.set_verbosity_error()
        diffusers_old.utils.logging.set_verbosity_error()
    ...
    validation_pipeline.load_lora_weights("/root/autodl-fs/rank4_0.001/checkpoint-100000/pytorch_lora_weights.safetensors")
    ...
    for step, batch in enumerate(input_dataloader):
        ...
        if validation_data.use_null_inv:
            ...
            ddim_inv_latent = ddim_inversion(
                ...
                num_inv_steps=validation_data.num_inv_steps, prompt="", lora_begin=lora_begin, lora_end=lora_end,
        ...
        for idx, prompt in enumerate(validation_data.prompts):
            ...
            sample = validation_pipeline(prompts, generator=generator, latents=ddim_inv_latent, 
                                         uncond_embeddings=uncond_embeddings, lora_begin=lora_begin, lora_end=lora_end, 
